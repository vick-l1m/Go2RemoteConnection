...
#### **A) Create `start_p2Dingo.sh`**

```bash
cd ~/go2_ws/Go2RemoteConnection
nano /start_p2Dingo.sh
```
...
echo "📋 Next steps:"
echo "1. Test backend:"
echo "   curl http://$PUBLIC_IP/health -H \"Authorization: Bearer \$(cat ~/go2_ws/Go2RemoteConnection/token.txt)\""
echo ""
echo "2. Start frontend:"
echo "   cd ~/go2_ws/Go2RemoteConnection/src/p2_remote_connection/app"
echo "   python3 -m http.server 8280"
echo "   Open: http://localhost:8280/go2_joystick.html"
```
