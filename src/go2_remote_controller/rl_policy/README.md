...
python ~/Go2_RL_workflow/Go2RemoteConnection/src/go2_remote_controller/rl_policy/dump_isaac_joint_order.py
...
```bash
cd ~/Go2_RL_workflow/Go2RemoteConnection/src/go2_remote_controller/rl_policy
